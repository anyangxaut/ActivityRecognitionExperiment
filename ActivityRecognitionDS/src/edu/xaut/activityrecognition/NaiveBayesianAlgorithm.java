...
public class NaiveBayesianAlgorithm {
	...
	public void trainNBC() {
		
		// 在WeightType下，对于locomotion = 1
		// 查询相关数据
		String sqlStand = "select * from dsfusion where locomotion = 1;";
		...
		// 查询相关数据
		String sqlWalk = "select * from dsfusion where locomotion = 2;";
		...
		// 查询相关数据
		String sqlSit = "select * from dsfusion where locomotion = 4;";
		...
		// 查询相关数据
		String sqlLie = "select * from dsfusion where locomotion = 5;";

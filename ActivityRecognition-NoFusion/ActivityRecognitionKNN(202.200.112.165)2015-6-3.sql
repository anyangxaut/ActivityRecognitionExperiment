...
# Dumping database structure for activityrecognitionknn
CREATE DATABASE IF NOT EXISTS `activityrecognitionknn` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `activityrecognitionknn`;


# Dumping structure for table activityrecognitionknn.featureextraction
...
# Dumping structure for table activityrecognitionknn.lie
...
# Dumping structure for table activityrecognitionknn.preprocessingdata
...
# Dumping structure for table activityrecognitionknn.sit
...
# Dumping structure for table activityrecognitionknn.stand
...
# Dumping structure for table activityrecognitionknn.walk
